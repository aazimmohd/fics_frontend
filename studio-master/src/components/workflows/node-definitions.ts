...
export const nodeDefinitions: NodeDefinition[] = [
  ...
  { type: 'condition', label: 'Condition', icon: GitFork, description: "Branch workflows based on conditions.", defaultData: { type: 'condition', label: 'Condition Logic', conditions: { if: { variable: '', operator: 'equals', value: '' }, elseif: [], else: { enabled: false } } }, isToolNode: true },
  ...
  { type: 'humanTask', label: 'Human Task', icon: UserRoundCheck, description: "Pauses the workflow and assigns a task to a person with timeout and escalation.", defaultData: { type: 'humanTask', label: 'Manual Approval Step', assigneeId: null, taskTitle: 'Please review and approve.', timeoutMinutes: 2, escalationEnabled: true, maxEscalations: 3, backupAssigneeId: null }, isToolNode: true },
